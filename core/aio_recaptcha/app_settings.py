...
RECAPTCHAV3_SITE_KEY  = getattr(settings, "RECAPTCHAV3_SITE_KEY", "6LcBC_kZAAAAAEZLiwQ2C0FGQE1VD7yYX2FSwW0r")
RECAPTCHAV3_SECRET_KEY = getattr(settings, "RECAPTCHAV3_SECRET_KEY", "6LcBC_kZAAAAADHV8gVD-GMLhr-rZ7c3IMa3hCh7")
...
if not RECAPTCHA_DEV_MODE and RECAPTCHA_ALWAYS_FAIL:
    raise ImproperlyConfigured("You cannot be in Always Fail Mode when you are not running dev mode")